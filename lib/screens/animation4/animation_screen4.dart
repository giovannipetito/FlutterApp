...
class _SnakeNavigationBarScreenState
    extends State<SnakeNavigationBarScreen> {
    ...
    return Scaffold(
        ...
        child: PageView(
          ...
          children: <Widget>[
            PagerPageWidget(
              ...
              image: Image.asset('images/diamond.png', height: 200.0,),
            ),
            PagerPageWidget(
      ...
      bottomNavigationBar: SnakeNavigationBar.color(
        ...
        items: [
          ...
          const BottomNavigationBarItem(
              icon: Icon(Icons.account_circle), label: 'calendar'),
          const BottomNavigationBarItem(
              icon: Icon(Icons.email), label: 'home'),
          const BottomNavigationBarItem(
              icon: Icon(Icons.phone), label: 'microphone'),
          const BottomNavigationBarItem(
              icon: Icon(Icons.add_shopping_cart), label: 'search')
        ],
