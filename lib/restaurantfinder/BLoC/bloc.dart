...
/// gli streams possono produrre più valori nel tempo. Se un Future è un valore
/// che verrà fornito alla fine, uno stream di una serie di valori verrà fornito
/// sporadicamente nel tempo.
/// Il pacchetto dart: async fornisce un oggetto chiamato StreamController.
/// Gli StreamController sono oggetti manager che istanziano sia uno stream che
/// un sink. Un sink è l'opposto di uno stream. Se uno stream produce valori di
/// output nel tempo, un sink accetta i valori di input nel tempo.
